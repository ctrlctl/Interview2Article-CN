...
### Bastl Instruments 中国行专访 × Entropy_Synth
...
![Bastl Instruments Neo Trinity](images/Bastl_Instruments_Neo_Trinity_module.jpg)
...
![Bastl Instruments Dark Matter](images/Bastl_Instruments_Dark_Matter_Eurorack_module.jpg)
...
而且要**便宜**，让所有人都买得起——因为模块化这条路本身可以非常贵。
...
![Bastl Instruments Kastle 2](images/Bastl_Instruments_Kastle_2_synthesizer.jpg)
...
**开发者**：Alchemist 是一个合成器固件，内置**五种不同的合成模式**，既灵活又音乐化。

这五种模式互相之间互补得很好；我最喜欢的一点是，你还可以**在不同模式之间做互相调制**——比如拿 FM 合成去调制减法合成，过渡非常自然。如果你用纯模块化去实现这种声音和模式切换，需要一大套设备。
...
**开发者**：我建议从**半模块（semi-modular）**开始。半模块通常自带了上手所需要的一切；从一台半模块出发再去扩展，是一条比较舒服的路。

手里先有一台已经"预接好"的东西，然后再慢慢学怎么把它接去别的地方，总比从零开始接线要容易。

---

## 11 / 如果只能买一件 Bastl，买什么？

**Q：如果让你从零搭一套架子，只能先买一件 Bastl Instruments 的产品，你会选哪件？**

**开发者**：这个简单—— **Softpop**。

它自带声源，你可以灌进自己想要的声音，从一开始就能围绕自己喜欢的音色去工作。它带 **MIDI 输入**和**耳机输出**，你要接别的设备所需要的一切它都有。
...
![Bastl × RYK Softpop SP2](images/Bastl_RYK_Softpop_SP2_semi-modular_synthesizer.jpg)
...
![Noise Engineering Metal Fetishist](images/Noise_Engineering_Metal_Fetishist_tabletop.jpg)
...
![Elektron Digitone (first gen)](images/Elektron_Digitone_first_generation_FM_synthesizer.jpg)
